		...
		setup_images_events: function( product_object ) {
			...
			product_object.images.on( 'afterChange', function( event, slick, current_slide_index ) {
				...
				if(current_slide_index > 0) {
					jQuery(".slick-track>.iconic-woothumbs-images__slide>img").each(function() {
						jQuery(this).attr("src", jQuery(this).attr("t_src"));
						jQuery(this).attr("srcset", jQuery(this).attr("t_srcset"));
					});
				}
